...
namespace tmss.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var actionPost = pages.CreateChildPermission(AppPermissions.Pages_Tenant_Post, L("Post"));
            actionPost.CreateChildPermission(AppPermissions.Pages_Tenant_Post_CreatePost, L("CreateNewPost"));
