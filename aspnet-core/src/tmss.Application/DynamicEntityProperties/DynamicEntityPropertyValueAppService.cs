...
using tmss.DynamicEntityPropertyValues.Dto;

namespace tmss.DynamicEntityProperties
{
    [Authorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : tmssAppServiceBase, IDynamicEntityPropertyValueAppService
    {
