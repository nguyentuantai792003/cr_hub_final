...
namespace tmss.Install
{
    ...
    public class InstallAppService : tmssAppServiceBase, IInstallAppService
    {
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{tmssConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{tmssConsts.ConnectionStringName}", constring);
        }
